...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :inventory => Faker::Number.between(0,100), :description => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex accusantium hic facere, laudantium minus corporis rerum. Culpa impedit, aperiam? Nobis sed vero illo reprehenderit saepe, consequatur deleniti eligendi quam cumque.")
end
5.times do
