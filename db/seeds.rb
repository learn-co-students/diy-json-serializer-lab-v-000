...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => Faker::Lorem.paragraph(2, false, 4), :inventory => Faker::Number.between(1,500))
end
5.times do
